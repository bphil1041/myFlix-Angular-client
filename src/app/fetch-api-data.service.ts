...
export class FetchApiDataService {
  ...
  /* API CALL FOR ONE USER ENDPOINT */
  ...
  /* API CALL FOR ADD MOVIE TO FAVORITES ENDPOINT */
  ...
  /* API CALL FOR DELETE MOVIE FROM FAVORITES */
